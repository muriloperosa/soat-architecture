...
// FakeTransactionRunner is a no-op shared.TransactionRunner for use case
...
func (r *FakeTransactionRunner) Executar(ctx context.Context, fn func(ctx context.Context) error) error {
	r.Calls++
	return fn(ctx)
}
