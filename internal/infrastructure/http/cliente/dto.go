...
import domaincliente "github.com/muriloperosa/soat-architecture/internal/domain/cliente"
...
type CriarClienteRequest struct {
	...
	TipoPessoa domaincliente.TipoPessoa `json:"tipo_pessoa" binding:"required" example:"PF"`
...
type ClienteResponse struct {
	...
	TipoPessoa         domaincliente.TipoPessoa `json:"tipo_pessoa" example:"PF"`
