...
func NewRemoverPecaOrcamentoUseCase(orcamentoRepository domainorcamento.OrcamentoRepository) *RemoverPecaOrcamentoUseCase {
	return &RemoverPecaOrcamentoUseCase{orcamentoRepository: orcamentoRepository}
}
